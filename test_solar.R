...
save(predictors,file=paste0(path,"solar_energy_test_1.RData"))
load("~/solar/RF_2.RData")
pred<-predict(RF,predictors)
mae<-sum(abs(pred-solar_energy$ACME[start:stop]))/ticks
mae
